class SuppliersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @supplier.save
        format.html { redirect_to supplier_url(@supplier), notice: "Fornecedor gravado com sucesso." }
  ...
  private
    ...
    def supplier_params
      params.require(:supplier).permit(:fantasia, :razaosocial, :telefone, :endereco, :cidade, :estado, :email, :whatsapp, :site, :ativo, :cnpj, :cpf)
    end
end
